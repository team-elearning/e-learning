...
from classroom.domains.class_domain import ClassroomDomain
from classroom.apis.permissions import PermissionDenied, ConflictError, NotFoundError, InvalidOperation, ensure_is_admin_or_instructor, ensure_is_admin
...
def create_classroom(instructor: UserModel, name: str, description: Optional[str] = None) -> ClassroomDomain:
    """
    Create a classroom and add the instructor as the initial instructor member.
    Returns ClassroomDomain.
    """
